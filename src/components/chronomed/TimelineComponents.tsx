                ...
                <svg width="100%" height={height} className="overflow-visible absolute left-0 top-0">
                        ...
                        <linearGradient id={gradientId} x1="0" y1="0" x2="0" y2={height} gradientUnits="userSpaceOnUse">
                            {hasRefRange ? (
                                <>
                                    ...
                                    <stop offset={offMax} stopColor="#3B82F6" />
                                    <stop offset={offMin} stopColor="#3B82F6" />
                         ...
                         <linearGradient id={areaGradientId} x1="0" y1="0" x2="0" y2={height} gradientUnits="userSpaceOnUse">
                             {hasRefRange ? (
                                <>
                                    ...
                                    {/* Normal Range - Blue */}
                                    <stop offset={offMax} stopColor="#3B82F6" stopOpacity="0.05"/>
                    ...
                    {hasRefRange && (
                        <>
                            ...
                            <line x1={CHART_MARGIN.left} x2="100%" y1={yRefMin} y2={yRefMin} stroke="#3B82F6" strokeWidth={1} strokeDasharray="4,4" opacity={0.3} />
                        </>
                    )}
                    ...
                    {values.map((v, i) => {
                        ...
                        const pointColor = isAbnormal ? "#EF4444" : "#3B82F6";
